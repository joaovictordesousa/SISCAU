    ...
    <tbody class="table-group-divider">
      ...
      <tr>
        ...
        <td style="display: flex; gap: 10px;">
          ...
          <a href=" {{ route('principal.show', ['GuiasRecolhimento'=> $histo->id] ) }} " class="btn btn-info btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
